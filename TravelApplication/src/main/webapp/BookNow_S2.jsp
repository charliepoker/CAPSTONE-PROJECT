...
try
{
	...
	StringBuilder querybuilder = new StringBuilder();
	 String qry = querybuilder.append("select max(cast(substring(").append("TicketId").append(", 3,").append(" length(").append("TicketId").append(")-2) as INT)) from ").append("TicketDetails").toString();  

...
{       alert ("SendInfo is called for " + txtVal);
      /*   var txt1 = document.ctis["cons"]["TravelsId"].value;
        alert("The text1 is " + txt1); */
...
int DisRow=0;
	...
	%>
 	<tr class= <%=(DisRow%2!=0)? "row_even" : "row_odd"%>>
	    <td><a href="#" onclick="sendInfo('<%=TravelsId%>')"><%=TravelsId%></a></td></a>

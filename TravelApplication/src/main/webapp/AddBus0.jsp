	   ...
	   <TH COLSPAN="2"> Add Bus Details</TH>
		...
		<tr class="row_odd">
			<td>TravelsId<FONT COLOR="red">*</FONT></td>
				<TD><Input type=text name='TravelsId' value='<%=TravelsId%>' readonly></TD>
		</TR>
